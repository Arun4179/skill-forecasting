    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center gap-4">
              <p className="text-xs font-bold text-slate-400 uppercase tracking-tighter">Powered by Predictive Intelligence</p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => setState(prev => ({ ...prev, profile: { ...prev.profile, currentRole: e.target.value } }))}
                    />
                  </div>
                  <div>
      ...
      <footer className="py-20 border-t border-slate-100 mt-20">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-8">
          ...
          <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">&copy; 2024 Predictive Career Intelligence System</p>
        </div>
      </footer>
    </div>
  );
